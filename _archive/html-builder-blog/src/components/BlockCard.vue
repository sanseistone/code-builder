...
<template>
  <div class="overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm" :class="tone.bar" style="border-left-width: 4px; border-left-style: solid;">
    <!-- 卡片头部 -->
    <header class="flex items-center gap-1.5 border-b border-gray-100 bg-gray-50/70 px-2 py-1">
      <div
